...
function scr_draw_dialogue_pop(_text, _player, _color_background, _color_border){
    ...
    draw_rectangle(_player.x - LENGHTGRID - _anchor_border, _player.y - LENGHTGRID  * 0.5 + _anchor_border, 
                   _player.x + LENGHTGRID + _anchor_border, _player.y - LENGHTGRID * 3 - _anchor_border, 0);
    ...
    draw_rectangle(_player.x - LENGHTGRID, _player.y - LENGHTGRID * 0.5, 
                   _player.x + LENGHTGRID, _player.y - LENGHTGRID * 3, 0);
	// escribimos el texto en el pop
    draw_set_font(fnt_dialogos);
    draw_set_color(c_black);
    draw_text_ext(_player.x, _player.y - LENGHTGRID * 1.75, _text, 20, LENGHTGRID * 2);
